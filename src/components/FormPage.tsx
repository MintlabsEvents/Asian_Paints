...
const agendaOptions = [
  ...
  {value: "Category Penetration - Beyond Paints",        label: "Category Penetration - Beyond Paints:", sub: "Increase the CC site penetration mainly with Category 2, flooring, Admixtures" },
